"""
_04 - ajouter visible to None au bouton
_05 - separer en divers fichiers
_07 - change de scene pour demarrer (demarre le serveur)
_08 - anime un deplacement de bouton de bgui - voir simplelayout
_09 -
_10 - vide bgui - voir on_img_click
...
_13 - interface de l'entree
_14 - interface du lobby
_15 - cree Vue - qui contient les classes de HUD (les layouts...)
...
_18 - inscrit client (dans serveur)
_19 - affiche lobbylayout
...
class Controleur():
    ...
    def initierSimulation(self,rep):  # initalisation locale de la simulation, creation du modele, generation des assets et suppression du layout de lobby
        if rep[1][0][0]=="demarreSimulation":
            ...
            self.modele.initSimulation(rep[1][0][1]) # on initialise certains attyributs
    ...
    def genereAssets(self,participants):
        ...
        cam=objets["Camera"] # notre camera
