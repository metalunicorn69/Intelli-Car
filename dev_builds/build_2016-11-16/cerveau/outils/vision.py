...
class Vision():
    ...
    #retourne un tuple: deux objets représentant les images
    def prendrePhotoStereo(self):
    	if self.switchPhoto is True:
    		...
    		prendreScreenshot("gauche")

    		#droite
    		camera.position[0] = x + ratio
    		prendreScreenshot("droite")

    		self.switchPhoto = False



   	#Section codée par Sebastien
